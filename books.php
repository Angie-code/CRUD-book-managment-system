...
<body class="text-white bg-white">
    ...
    <div>
        <div class="bg-blue-900 p-4 flex justify-between">
            <div>
                <h1 class="text-2xl font-bold">LMS</h1>
            </div>
            <div>
                <a href="index.php" class="ml-4">HOME</a>
                <a href="#" class="ml-4">READ</a>
             ...
             <div class="mt-8  grid md:grid-cols-4 gap-10  mx-10">
                 ...
                 if(mysqli_num_rows($results)){
                    while($row= mysqli_fetch_array($results)){ ?>
                      <div class="hover:text-black overflow-hidden shadow-2xl rounded transition ease-in-out delay-150 bg-blue-900 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 ... ">
                        <img src="images/<?php echo $row["image_name"]?>" alt="book-cover" class="w-full h-60 w-30 " >
                          ...
                          <div class="px-6 pb-2 pt-4  ">
                              ...
                              <p class="block text-sm text-black font-semibold">By <?php echo $row["author"] ?></p>
                              <p class="block text-sm text-black font-semibold"><?php echo $row["prod_year"] ?></p>
                          </div>
                        </div>
                  <?php
                  }
